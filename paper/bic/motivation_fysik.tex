...
12mm cylindrical sample. \aleksandar{Better to give a brief chronological tour of how the sample
has been handled?} The cut samples are 6.5mm cubes \aleksandar{more accurate measures?}. This
...
\aleksandar{OBS: 846 i rå størelse, 810 er efter volume-matching.} \aleksandar{Important to explain
a bit about how the samples were cut during acquisition. How were the samples secured in order not
to be physically shifted too much etc.}
