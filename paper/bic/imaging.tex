...
\begin{figure}
  ...
  \caption{
    ...
    % streaks kan ses nederst i højre side i figur 11
    % LAV BILLEDE brug figur 11 øverst venstre, den inkluderer alle
    % forklar også glow ift contrast forskel på resin kanter for øvre
    % og nedre åre....
    (a.1) Implant glow
    (a.2) Ring artifacts
    (a.3) Streaks
    (a.4) Air/resin bubbles
    (a.5) Contrast-shifted glow 
