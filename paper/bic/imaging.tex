...
\begin{figure}
	...
	\caption{Mass attenuation coefficients for the bone mineral
	Hydroxyapatite (Ca$_{5}$(PO$_{4}$)$_{3}$(OH)) and the resin Methyl
	Methacrylate, MMA (C$_{5}$H$_{8}$O$_{2}$). The vertical line marks 50
	keV at which our data was acquired. The mass attenuation coefficients
	are computed using NIST XCOM \cite{NIST-XCOM}.
	}
