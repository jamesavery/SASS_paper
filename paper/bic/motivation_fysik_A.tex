...
\begin{tikzpicture}[>=latex']
        ...
        \node[block, right=of box0] (box1) {2D-histograms\\(from fields)};
        \node[block, right=of box1] (box2) {Curves for\\material identification};
        \node[block, right=of box2] (box3) {Probabilities};
        \node[block, right=of box3] (box4) {Segmentation};
