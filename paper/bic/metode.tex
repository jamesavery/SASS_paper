...
information. From our work in another paper \aleksandar{Reference ???}, we are able to obtain two
...
This section will describe each step of our method in detail. Going from tomography to material
...
belongs to material $m$ given that it has value $v$ and field value $x$.
