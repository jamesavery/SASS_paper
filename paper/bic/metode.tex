...
% TODO (Alle): tilpas størrelser i generering af figurer så det passer med
% colorbar og næste figurs størrelse
\begin{figure*}
    \centering
%    \begin{tabular}{cc}
...
% TODO (Alle): Større labels på akser, så det kan læses
\begin{figure}
    \centering
    \begin{tabular}{cc}
