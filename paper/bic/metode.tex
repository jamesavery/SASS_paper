...
% TODO (Alle): Stort set alle figurer skal have større ticks og labels på
% akser, så det kan læses, og de steder hvor der bruges colorbar, skal den
% tilpasses i størrelsen... Dette er klargjort i filen article_figures.py (TH2
% /aleksandar/) men 770c_pag skal genkøres i 1x forinden, da nogle array filer
% mangler.
