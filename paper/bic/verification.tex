...
% overgangen mellem små og store threads.
% JA: vi skal vise at vi HAR en automatisk metode
...
% TODO (James): Indsæt i brødtekst (Else eller Torstens artikel/phd)
% A : Auto B med membran
% B : Easy
% C : Crystal
% D : Tom
