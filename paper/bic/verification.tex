...
The bone-to-implant contact can be studied by looking at the distance to the
implant surface, alongside the tissue-to-implant contact. In particular, we are
interested in the difference between the old and new bone regions. We define
