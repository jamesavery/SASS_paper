...
\begin{figure}
  \centering
  \begin{tabular}{cc}
    (a) & \begin{tabular}{c} \includegraphics[width=0.96\columnwidth]{770c_pag-full-xy-1x.png}\end{tabular}\\
    (b) & \begin{tabular}{c} \includegraphics[width=0.96\columnwidth]{770c_pag-full-yz-1x.png}\end{tabular}\\
    (c) & \begin{tabular}{c} \includegraphics[width=0.96\columnwidth]{770c_pag-full-xz-1x.png}\end{tabular}
  \end{tabular}
