...
%TODO: Issue #2 pkt 5: Tilføj overgang, som binder det sammen med resten af artiklen.

\subsection{Data set}

5 critical size defects were introduced to 7 goats, with bone being cut accordingly in the region.
