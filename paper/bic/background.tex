...
The physical samples were prepared for SR$\mu$CT scanning by cutting out a portion from larger
 $\diameter$12mm H20mm cylindrical biopsies. %TODO: Issue #9. Aleksandar, hvor har du fundet det? Er det radius eller 
%TODO: Det kan jo ikke passe, da implantatet er 8mm. Prøverne er i øvrigt nærmere cylindriske end kubiske.
%The cut samples are cubes of size (6.478mm, 6.478mm, 6.146mm) in the $(x,y,z)$ direction respectively.
