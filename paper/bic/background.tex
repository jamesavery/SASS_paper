...
\begin{figure}
  \centering
  \begin{tabular}{c}
    \begin{tabular}{c}\includegraphics[width=\linewidth]{770c_pag-bic-xy-1x.png}\end{tabular}\\
    \begin{tabular}{c}\includegraphics[width=\linewidth]{770c_pag-bic-yz-1x.png}\end{tabular}\\    
  \end{tabular}
  \caption{
    ...
    blod vessel voxels have higher values than bone voxels further out. As we approach the implant,
    the value-shifts accellerates and becomes highly non-linear.
    ...
    We especially see artefacts within and around the titanium implant.    
    (b) A 1.5mm x 1.5mm region of an image slice in the YZ-plane. This
    hightlights noise and voxel effects around the newly formed bone in the micro threaded part of
...
Looking at the XY-slice in \Cref{fig:xy-slice} we see clear concentric ring artefacts emanating from
