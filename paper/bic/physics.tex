...
\begin{figure}
  ...
  \end{tabular}
  \caption{
    To better see the distortion effects, we zoom in on sub-regions of the
    ...
    (b) A 1.5mm x 1.5mm region of an image slice in the YZ-plane in the
    micro-threaded part of the titanium implant.
  }
\label{fig:slices}
\end{figure}

In \Cref{fig:slices}, we see zoomed-in regions of the XY- and YZ-planes of the
